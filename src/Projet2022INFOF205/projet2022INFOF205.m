...
if exist('tmax','var') ~= 1, tmax = 6; end
if exist('nsteps','var') ~= 1, nsteps = 4000; end
if exist('stepsize','var') ~= 1, stepsize = tmax/nsteps; end
%if exist('stepsize','var') ~= 1, stepsize = stepsize*100; end

%if exist('playvideo','var') ~= 1, playvideo = false; end
...
if playvideo==true, figure(1)
   ...
   %rollonhills(xx,yy,vhatE,0.03,wheelcolor,11)
